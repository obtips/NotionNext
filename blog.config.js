...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '187404', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '始于印象派', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://187404.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '印象派, 艺术, 博客', // 网站关键词 英文逗号隔开
